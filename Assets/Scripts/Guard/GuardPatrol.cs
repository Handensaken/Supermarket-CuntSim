...
namespace Guard
{
    ...
    public class GuardPatrol : GuardState
    {
        ...
        public void UpdateTargetPoint(int newPatrolIndex)
        {
            ...
            Vector3 dir1 = guardBehaviour.transform.forward;
            dir1.y = 0;
            Vector3 dir2 = (guardBehaviour.PatrolPoints[newPatrolIndex]+guardBehaviour.StartPos - guardBehaviour.transform.position).normalized;
            dir2.y = 0;
